...
const GetProductByName = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.get(`http://localhost:8085/api/v1/products/${productName}/prod`);
            ...
            <div style={{ backgroundColor: '#e7eaf6', textAlign: 'center', minHeight: '100vh', paddingBottom: '50px' }}>
                ...
                <Container>
                    ...
                    <form onSubmit={handleSubmit} style={{ marginBottom: '20px' }}>
                        <label htmlFor="productName" style={{ marginRight: '10px', fontWeight: 'bold' }}>Enter Product Name:</label>
                        <input
                            type="text"
                            id="productName"
                            value={productName}
